        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between">
                        <div>
                            <p class="text-muted mb-1">Checked In</p>
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between">
                        <div>
                            <p class="text-muted mb-1">Not Checked In</p>
            ...
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            <h5 class="fw-bold mb-1">Check-in Progress</h5>
                            <p class="text-muted mb-0">Guest attendance overview</p>
                        </div>
                        <i class="fa-solid fa-chart-pie fs-3 text-primary"></i>
                    </div>
                    <div class="text-center py-4">
                        <h1 class="display-4 fw-bold">72%</h1>
                        <p class="text-muted">Guests have checked in</p>
